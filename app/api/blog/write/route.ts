...
export async function POST(req: NextRequest) {
 ...
 const prompt= `write the detailed and informative article on the topic ${topic}  for the target audience ${targetAudience} in ${tone} tone with ${wordCount} words count and article type ${articleType}`;
